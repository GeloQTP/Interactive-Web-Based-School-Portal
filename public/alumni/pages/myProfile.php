...
<body>
    ...
    <?php
    include __DIR__ . '/../components/edit_myProfileModal.php';
    ?>

    <?php
    include __DIR__ . '/../components/alumniNavbar_myProfile.php';
    ?>

    <?php
    include __DIR__ . '/../components/editProfilePicture.php';
    ?>
        ...
        <div class="main">
            ...
            <div class="position-relative">
                ...
                <div class="position-absolute bottom-0 end-0 me-1 mb-1">
                    <button class="btn bg-primary text-light border border-light border-3 d-flex align-items-center justify-content-center shadow"
                        style="border-radius: 50%; width: 45px; height: 45px;"
                        data-bs-toggle="modal"
                        data-bs-target="#editProfileBanner"> <!--TODO: UPDATE BANNER FOR ALUMNIS-->
                ...
                <div id="student_fullname" class="ms-lg-3">
                    ...
                    <div class="d-flex flex-column flex-lg-row align-items-center align-items-lg-start">
                        ...
                        <p class="text-center text-lg-start h3 mb-2 mb-lg-0">
                            ...
                            <span class="small ms-2 text-primary">
            ...
            <div class="text-center d-flex flex-column text-lg-start">
                ...
                <div class="d-flex mx-auto">
                    ...
                    <p class="mb-1 badge border text-dark">Email: <span class="ms-2 text-primary"><?= $row['Email'] ?></span></p>
                </div>
                <div class="d-flex mx-auto">
